...
const Navbar: React.FC<PropsType> = ({ searchTerm, setSearchTerm, user }) => {
  ...
  return (
    <div className="flex gap-2 md:gap-5 w-full mt-5 pb-7">
      <div className="flex justify-start items-center w-full px-2 rounded-md bg-mainColor border-none outline-none focus-within:shadow-sm">
        ...
        <input
          ...
          className="p-2 w-full outline-none bg-mainColor"
        />
      </div>
